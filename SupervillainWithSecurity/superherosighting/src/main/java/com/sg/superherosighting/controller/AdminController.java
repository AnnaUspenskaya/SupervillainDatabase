...
import com.sg.superherosighting.daos.RoleDao;
import com.sg.superherosighting.daos.UserDao;
   ...
   @GetMapping("/admin")
    ...
    public String editUserDisplay (Model model, Integer id, Integer error){
        ...
        model.addAttribute("roles", roleList);
                if(error != null) {
            if(error == 1) {
                model.addAttribute("error", "Secret words did not match, Secret word was not updated.");
            }
        }
        return "editUser";
    }
